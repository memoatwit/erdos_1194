...
AP-degree. On 500 matched raw assignments, global degree improves the 60-s
...
\item
  ...
  witness-anchored cover. A fixed-seed 100-survivor follow-up measures the
...
\path{results/global_degree_survivor_solver_summary.json}.\par}
