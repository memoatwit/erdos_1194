...
This paper's contribution is an evaluated constraint-solving methodology and
certified benchmark, not a new exact value of A003002. It measures how
problem-specific implied constraints, cube-selection policies, and solver
configurations interact on one reproducible family. We provide:
...
ground truth at solved sizes and a measured constraint-solving difficulty
...
T2 solver portfolio. The total retained-log estimate is roughly 11,310
...
a configuration-grading ladder for the tested CP-SAT, HiGHS, and CDCL
configurations.
...
The large solver artifacts are archived in Zenodo Version 2 at
\url{https://doi.org/10.5281/zenodo.21413746}. It includes the
...
\cite{ergezer-r3-212-artifacts-2026}. Version 2 also adds the
certified T1c formula/proof pairs and provenance records, the full T2 survey,
the same-formula solver and optimization-MIP outputs, the exact-value DRAT/LRAT
certificate suite, and the six solve-time-stratified global-degree survivor
CNF/DRAT/LRAT bundles with their provenance records. Each formula and proof is accompanied by a SHA-256 digest
...
Total retained logs & $\sim11{,}310$ & sum of the rounded rows above; excludes interactive debugging, failed encode attempts, and logs not retained locally \\
\end{longtable}
}
