...
\item
  ...
  CP-SAT configuration, whereas kissat closes 79/100 within two hours.
\item
...
T2 solver portfolio. The total retained-log estimate is roughly 11,324
...
T3 & deterministic generators & 12,582,912 witness-prefix or 96,847 global-degree cubes & complete covers; on 100 global-degree survivors CP-SAT closes 0 and kissat closes 79 without proofs & full upper-bound proof \\
\end{longtable}
}
...
\item
  ...
  run so far: CP-SAT closes 0 and kissat closes 79 without proof logging.
...
Total retained logs & $\sim11{,}359$ & excludes interactive debugging, failed encode attempts, and logs not retained locally \\
\end{longtable}
}
