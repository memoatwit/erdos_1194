...
- Dataset: [Zenodo 10.5281/zenodo.21413746](https://doi.org/10.5281/zenodo.21413746)
- Submission snapshot: [`constraints-submission-v1.5`](https://github.com/memoatwit/erdos_1194/tree/constraints-submission-v1.5/erdos_r3)
...
@misc{ergezer-r3-212-2026,
  ...
  title         = {Salem--Spencer sets as a constraint-solving benchmark:
